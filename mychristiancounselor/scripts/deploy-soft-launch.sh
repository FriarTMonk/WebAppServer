...
API_SERVICE="api"
WEB_SERVICE="web"
API_VERSION="infrastructure-hardening-v1"
WEB_VERSION="infrastructure-hardening-v1"
...
echo "   Phase 5: Two-Factor Authentication requires new database columns."
echo "   Connect to your RDS database and run:"
echo ""
echo "   cd packages/api"
echo "   npx prisma migrate deploy"
echo ""
echo "   This will apply migration: 20260116000000_add_two_factor_auth"
echo "   (Adds 2FA columns to User table: twoFactorEnabled, twoFactorMethod, etc.)"
echo ""
echo "   ${YELLOW}Note: Previous migrations (account deletion) should already be applied.${NC}"
echo ""
...
echo ""
echo "3. ${YELLOW}Test Phase 5 features:${NC}"
echo "   - Two-Factor Authentication (TOTP): https://mychristiancounselor.online/settings/security"
echo "   - Two-Factor Authentication (Email): https://mychristiancounselor.online/settings/security"
echo "   - Security Banners: Login to see deployment/encouragement banners"
echo "   - Admin 2FA Dashboard: https://mychristiancounselor.online/admin/security/2fa"
echo ""
