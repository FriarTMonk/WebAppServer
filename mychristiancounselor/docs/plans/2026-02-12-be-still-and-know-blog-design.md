# "Be Still and Know" Blog Post - Design Document
...
A blog post exploring Psalm 46:10 ("Be still and know that I am God") through a three-part framework: Let Go (yesterday), Be Still (today), Don't Worry (tomorrow). Uses parallel structure to contrast our way (striving, controlling, worrying) with God's invitation (surrender, stillness, trust).

**Author Context**: Written from the middle of personal uncertainty—informed by lived experience but focused on the reader's journey. Includes vulnerable personal note in conclusion.
...
### Three-Part Journey:
1. **Let Go** (Yesterday/The Past) - Release control, stop grasping
2. **Be Still** (Today/The Present) - Rest in God's presence now
3. **Don't Worry** (Tomorrow/The Future) - Trust God with what's ahead

### Scripture Framework:
- **Proverbs 16:9** - Our plans vs. God's sovereignty (Let Go)
- **Psalm 46:10** - Be still and know (anchor throughout)
- **Isaiah 40:31** - Waiting renews strength (Be Still)
- **Matthew 6:34** - Don't worry about tomorrow (Don't Worry)
- **Philippians 4:6-7** - Anxiety vs. peace (Don't Worry)
- **1 Peter 5:8** - Enemy like a roaring lion (Personal note)
- **Luke 22:42** - Not my will but Yours (Personal note)
...
## Section 2: Let Go (Yesterday/The Past)

### Heading: Let Go: Release the Illusion of Control
...
**Scripture Anchor - Proverbs 16:9:**
...
## Section 3: Be Still (Today/The Present)

### Heading: Be Still: Rest in God's Presence Today
...
**The Transformation - Isaiah 40:31:**
...
## Section 4: Don't Worry (Tomorrow/The Future)

### Heading: Don't Worry: Trust God with Tomorrow
...
## Section 5: Conclusion & Practical Application

### Heading: The Daily Practice of Surrender
...
- Coming soon: Our blog on burnout and rest

---

## Implementation Notes

**File Location**: `packages/web/content/blog/be-still-and-know-finding-peace-in-uncertainty.mdx`

**Components to Use**:
- `<KeyTakeaway>` - After introduction
- `<Scripture>` - For main Bible verses
- `<PrayerPrompt>` - In conclusion
- `<Warning>` - Optional, for mental health disclaimer
- `<CallToAction>` - At end (or use simpler text CTA)

**Tone**: Pastoral, warm, vulnerable, practical. Written from the middle of struggle, not from victory looking back.

**Key Theme**: Parallel structure contrasting our way (control, striving, anxiety) with God's invitation (surrender, stillness, trust).
...
### Primary Scriptures:
1. **Psalm 46:10** - "Be still and know that I am God" (anchor verse)
2. **Proverbs 16:9** - "Humans plan, but LORD establishes steps"
3. **Isaiah 40:31** - "Those who wait on the LORD renew their strength"
4. **Matthew 6:34** - "Do not worry about tomorrow"
5. **Philippians 4:6-7** - "Do not be anxious... peace of God will guard"

### Supporting Scriptures:
6. **1 Peter 5:8** - "Enemy prowls like a roaring lion"
7. **Luke 22:42** - "Not my will, but yours be done"

All scriptures should be NIV unless otherwise noted.
